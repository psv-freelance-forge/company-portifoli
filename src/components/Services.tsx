      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-20">
          <div className="max-w-xl">
            <span className="color-orange font-bold text-sm tracking-[0.3em] uppercase mb-4 block">Our Expertise</span>
            <h2 className="text-4xl md:text-6xl font-black text-white leading-tight">Elevating brands through robust tech.</h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service, i) => (
            <div key={i} className="p-10 rounded-[2.5rem] bg-zinc-900/30 border border-zinc-800/80 transition-all hover:bg-zinc-900/50 hover:border-orange/30 group">
